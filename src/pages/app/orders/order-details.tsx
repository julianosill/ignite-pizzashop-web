...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 214u82931a</DialogTitle>
      ...
      <div className="space-y-6">
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Juliano Sill</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">a@a.com</TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell>Pizza Sensação</TableCell>
